...
\location{Expected May 2020 | Ithaca, NY}
...
\section{Links} 
github.com/\href{https://github.com/cornellian}{\custombold{cornellian}} \\
...
%\section{Awards} 
%%\begin{tabular}{rll}
%Capital One SWE Summit Participant\\
%Top 10, HackUMBC Spring 2016
%%2016	     & 2\textsuperscript{nd} most points  & Google Code Jam, Qualification Round\\
...
%\item 
%%\item Lorem Ipsum derp derp derp, herp derp derp DERP DERP
%%\item I like big pancakes and I cannot lie
%\end{tightemize}
%\sectionsep
...
\item Designed and implemented a ship-seeking algorithm that is 100\% more efficient (in \# moves) than random firing, 23\% better than naive searching.
\end{tightemize}
...
\begin{tightemize}
\item Full stack application that wraps basic Yelp functionality in a chatbot interface. 
