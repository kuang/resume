...
linkedin.com/in/\href{https://www.linkedin.com/in/justinkuang}{\custombold{justinkuang}} \\
...
\location{Grad. May 2020 | Ithaca, NY}
\location{GPA: 3.55 }
\sectionsep
\spacerone
...
\location{Grad. 2016 | Baltimore, MD}
\sectionsep
...
\runsubsection{Yelp}
\descript{| Incoming SWE Intern }
\location{Fall 2018 | San Francisco, CA}
...
\descript{| SWE Intern }
\location{Summer 2018 | Menlo Park, CA}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\descript{| SWE Intern }
\location{Summer 2017 | Southlake, TX}
\begin{tightemize}
...
\section{Business}
%\runsubsectionNoUpper{UniVRsity}
%\descript{| Business Operations and Strategy }
%\location{Spring 2018-Present | Ithaca, NY}
%\begin{tightemize}
%\item
%\end{tightemize}
%\sectionsep
...
\location{August 2016-Present | Ithaca, NY}
\begin{tightemize}
